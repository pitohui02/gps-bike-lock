...
// import { IonContent, IonHeader, IonMenu, IonList, IonItem } from '@ionic/react';
...
//             <IonItem detail-icon="none" lines='none' className='log-out-btn' button onClick={() => setShowLogoutAlert(true)}>
...
//         </div>
//       </IonMenu>
//       <PopupLogout isOpen={showLogoutAlert} onDidDismiss={() => setShowLogoutAlert(false)} />
//     </div>
//   );
// };
...
import React, { useState } from 'react';
import { IonContent, IonHeader, IonMenu, IonTitle, IonToolbar, IonList, IonItem, IonIcon, IonLabel } from '@ionic/react';
import PopupLogout from '../components/Popup-Logout'; 
import './Sidebar.css';
import logout from "../assets/logout-txt-sb.svg";
import about from "../assets/about-txt-sb.svg";
